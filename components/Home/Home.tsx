...
export default function (){
    return(
        <div className="w-full h-full flex flex-col mt-5 lg:mt-24">
        <div><Accounts /></div>
        <div><Wicon /></div>
        <div className=" relative bg-orange-400 w-full md:h-96 lg:h-[30rem] flex flex-col-reverse md:flex-row items-center py-4"> 
           <div className="w-full text-white lg:w-1/2 mb-8 lg:mb-0 px-12  sm:px-12">
            <h1 className="text-2xl sm:text-2xl md:text-4xl font-bold  mb-4">Your Travle Luck</h1>
         ...
         <div className="w-full lg:w-1/2 md:h-96 lg:h-[30rem] mb-12 md:mb-0">
           <img src="https://www.favotrip.nl/assets/images/favotrip-header.png" alt="favotrip-header" className="w-full h-full object-cover"/>
         </div>
        </div>
