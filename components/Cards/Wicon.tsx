...
const  Wicon: React.FC = () => {
    ...
    return(
            <div className="fixed z-50 group">
              ...
              <span className="absolute hidden md:block right-12 md:right-20 top-1 -translate-y-1/2 whitespace-nowrap
                                bg-black text-white md:text-white text-sm px-4 py-3 rounded-full bottom-3 opacity-0 
                                group-hover:opacity-100 transition"
              >Do you have questions? WhatsApp us !</span>
            </a>
            </div>
    );
};
