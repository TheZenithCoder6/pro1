...
export default function Text(){
    return(
        <div className=" w-full px-4 md:px-32">
            <div className="flex flex-col md:flex-row w-full gap-8 mt-12 md:mt-32 md:gap-12">
            <div className="w-full flex flex-col md:flex-row justify-start gap-4">
            <div><h2 className="font-sm text-2xl md:text-3xl">Discover your travel happiness during your next holiday</h2>
            ...
            <div><h2 className="font-sm text-2xl md:text-3xl">Select one of our trips with the help of our local experts</h2>
            <p className="mt-4 text-gray-700">Our travel specialists are curious travelers just like you. They know where to go, what you certainly don't want to miss and which hidden places really make a destination special
                ...
                <div className="mt-6">
                 <h2 className="font-sm text-2xl  md:text-3xl">Discover more</h2>
