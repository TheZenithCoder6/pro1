...
export default function Navbar(){
    ...
    return(
        <nav className=" fixed top-0 left-0 w-full md:h-24 bg-white shadow-sm z-50 ">
            <div className="max-w-7xl mx-auto px-4 md:mt-4">
          ...
          {/* MOBILE LEFT SLITE */}
             <div className={`fixed bg-white inset-0 top-0 left-0 h-full shadow-md z-[60] transform transition-transform duration-600 ease-in-out
                  ...
                  <div className="p-4 flex flex-col gap-4 text-gray-700 text-md ">
                    <button onClick={() => setOpen(false)} className="text-gray-700 self-end mt-4 "><HiOutlineX size={32}/></button>
                      <Link href="/">
                        <img
                         src="/favotrip-logo.svg"
                         alt="favotrip-logo"
                                        ...
                                        <img 
                                         ...
                                         alt="search-vector"
                                          className="w-6 h-6"/>
                                           ...
                                           <button onClick={() => setOpen(false)} className="text-gray-600 ml-4 "><HiOutlineX size={28}/></button>    
                                       </div>
